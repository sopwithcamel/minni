...
for uniq in [10, 20, 30, 40, 50, 60, 70]:
    for rep in [int(100/uniq), int(1000/uniq)]:
        ...
        subprocess.call("../config/mod -minni__input_files dataset.txt -minni__internal__cbt__buffer_size " + str(buffer_size) + " -minni__internal__cbt__fanout " + str(fanout), shell=True)
