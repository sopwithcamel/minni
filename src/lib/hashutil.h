...
// MurmurHash2
uint32_t MurmurHash(const void *buf, size_t length, uint32_t seed = 0);

// FNV Hash
uint32_t FNVHash(const char *buf, size_t length);

// SuperFastHash
size_t SuperFastHash(const char *buf, size_t len);
