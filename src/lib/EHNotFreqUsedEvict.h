#ifndef LIB_EHNOTFREQUSEDEVICT_H
#define LIB_EHNOTFREQUSEDEVICT_H
...
class EHNotFreqUsedEvict {
	public:
		EHNotFreqUsedEvict(uint64_t capacity, uint64_t partid); /* constructor */
		EHNotFreqUsedEvict(uint64_t capacity, uint64_t partid, const string &path); /* load constructor, from a "dump" file */
		~EHNotFreqUsedEvict(); /* destructor */
...
typedef EHNotFreqUsedEvict MapperAggregator;
